export enum FootprintType {
    ...
    HOT_SPRING = 1 << 16,
    LOGISTICS = 1 << 17,
    MUST_BE_ON = WATER | MINE | GEO_VENT | OIL_WELL | SAND | FUSION_PLANT | COAL_PLANT | NUCLEAR_PLANT | OIL_PLANT | GEM_MINE | SPECIAL | LITHIUM_MINE | COLLEGE | HOT_SPRING | LOGISTICS,
    ALL = EMPTY | RESIDENCE | OCCUPIED | WATER | MINE | GEO_VENT | OIL_WELL | SAND | FUSION_PLANT | COAL_PLANT | NUCLEAR_PLANT | OIL_PLANT | GEM_MINE | SPECIAL | LITHIUM_MINE | COLLEGE | HOT_SPRING | LOGISTICS
}