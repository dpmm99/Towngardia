export enum FootprintType {
    ...
    LITHIUM_MINE = 1 << 14,
    COLLEGE = 1 << 15,
    MUST_BE_ON = WATER | MINE | GEO_VENT | OIL_WELL | SAND | FUSION_PLANT | COAL_PLANT | NUCLEAR_PLANT | OIL_PLANT | GEM_MINE | SPECIAL | LITHIUM_MINE | COLLEGE,
    ALL = EMPTY | RESIDENCE | OCCUPIED | WATER | MINE | GEO_VENT | OIL_WELL | SAND | FUSION_PLANT | COAL_PLANT | NUCLEAR_PLANT | OIL_PLANT | GEM_MINE | SPECIAL | LITHIUM_MINE | COLLEGE
}