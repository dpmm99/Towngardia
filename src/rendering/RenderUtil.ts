...
export function getInUseSpriteURLs(city: City): { [key: string]: string } {
    ...
    const otherSprites = [
        ...
        /*errors and view-specific icons on any building*/ 'noroad', 'nopower', 'outage', 'fire', 'provision', 'cannotprovision', 'reopen', 'errorbackdrop', 'warningbackdrop', 'collectionbackdrop',
    ];
